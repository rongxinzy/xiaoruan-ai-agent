...
晓软智能体 is an Electron + React desktop application for local-first AI Agent workflows. Its core areas are:
...
- `frontend-ui-change-strategy` is the project-specific entry point for existing 晓软Agent UI changes.
