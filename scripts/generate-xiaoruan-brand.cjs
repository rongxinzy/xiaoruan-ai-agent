...
async function build() {
  ...
  for (const [theme, color] of [
    ...
    output(
      ...
      Buffer.from(
        `<svg xmlns="http://www.w3.org/2000/svg" width="800" height="96" viewBox="0 0 800 96"><title>晓软政务办公智能体</title><image href="data:image/png;base64,${markData}" width="96" height="96"/><text x="116" y="63" fill="${color}" font-family="system-ui,sans-serif" font-size="54" font-weight="600">晓软政务办公智能体</text></svg>\n`,
      ),
    );
    ...
    ctx.fillText('晓软政务办公智能体', 280, 150);
