# Contributing to 晓软Agent

Thank you for your interest in contributing to 晓软Agent. Contributions of all sizes are welcome, including bug reports, documentation improvements, tests, UI refinements, and new features.
...
晓软Agent uses Electron process isolation. Renderer code must not access Node.js or Electron APIs directly; use the typed preload and IPC boundary.
...
- Use the public product name **晓软Agent** in English-facing product copy.
