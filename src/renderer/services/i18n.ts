...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    localInferenceRuntimeCardDescription:
      '可选组件，不影响晓软智能体的其他功能。选择后在应用内下载、校验和安装。',
    ...
    localInferenceImportRuntimeTooltip:
      '选择本地推理 backend 主包压缩包（zip 或 tar.gz），或选择已解压的完整目录，导入到晓软智能体 管理的 backend 目录。',
    ...
    codingWorkspaceDescription: '挂载一个或多个现有文件夹；晓软智能体不会移动或重命名磁盘文件。',
    codingWorkspaceDefaultAgent: '默认 Agent',
    codingWorkspaceName: '工作区名称',
    codingWorkspaceNamePlaceholder: '例如：晓软智能体',
    ...
    codingWorkspaceRemoveConfirm: '仅移除晓软智能体中的编程记录，不会删除磁盘文件。',
    ...
    coworkHomeSubtitle: '连接企业知识，让协作更高效',
    coworkWorkingDirectory: '工作目录',
    coworkWorkingDirectoryPlaceholder: '输入项目路径',
    coworkWorkingDirectoryHint: '晓软智能体 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为晓软智能体 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义晓软智能体 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '晓软智能体 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkEngineArchInfo: '晓软智能体 采用双内核并行架构，两个引擎同时常驻运行，按职责固定分工：',
    coworkEnginePiRole:
    ...
    coworkConfigSaveFailed: '保存晓软智能体 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '晓软智能体 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '晓软智能体 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    mcpConnectSubtitle: '授权后，晓软智能体将在你允许的范围内使用此服务。',
  ...
  en: {
    ...
    localInferenceImportRuntimeTooltip:
      'Select a local inference backend archive (zip or tar.gz), or a fully extracted backend directory, to import into the backend directory managed by 晓软Agent.',
    ...
    codingWorkspaceNamePlaceholder: 'For example: 晓软Agent',
    ...
    // 晓软Agent
    cowork: '晓软Agent',
    coworkSettings: '晓软Agent Settings',
    ...
    coworkHomeSubtitle: 'Connect enterprise knowledge for more efficient collaboration',
    coworkWorkingDirectory: 'Working Directory',
    coworkWorkingDirectoryPlaceholder: 'Enter project path',
    coworkWorkingDirectoryHint: '晓软Agent will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for 晓软Agent...',
    coworkSystemPromptHint: "Optional system prompt to customize 晓软Agent's behavior",
    ...
    coworkModelSettingsHint:
      '晓软Agent uses the current model and provider configuration from Model Settings.',
    ...
    coworkEngineArchInfo:
      '晓软Agent runs a dual-kernel architecture with both engines running simultaneously, each with fixed responsibilities:',
    coworkEnginePiRole:
    ...
    coworkConfigSaveFailed: 'Failed to save 晓软Agent settings. Please try again.',
    ...
    coworkPermissionDescription: '晓软Agent is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: '晓软Agent needs your input',
    ...
    mcpConnectSubtitle:
      'After authorization, 晓软Agent will use this service within the scope you allow.',
