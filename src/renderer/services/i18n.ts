...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    aisphereAddress: 'AISphere地址',
    aisphereAddressPlaceholder: 'https://平台地址 或 http://平台地址',
    aisphereDescription: '连接 AISphere 平台后，只能使用平台提供的模型。',
    aisphereConnect: '连接并获取模型',
    aisphereConnecting: '正在连接…',
    aisphereRefresh: '刷新模型',
    aisphereConnected: '已连接 AISphere',
    aisphereUnconfigured: '请先配置 AISphere地址。',
    aisphereDefaultModel: '默认模型',
    aisphereSelectModel: '请选择平台模型',
    aisphereNoModels: '平台当前没有可用模型。',
    aisphereInvalidAddress: '请输入有效的 HTTP 或 HTTPS 平台地址，不要包含接口路径。',
    aisphereInvalidPlatform: '该地址未通过 AISphere 平台验证。',
    aisphereInvalidModels: '平台返回的模型列表无效，请联系平台管理员。',
    aisphereUnavailable: '无法连接 AISphere，请检查平台地址和网络后重试。',
    aisphereMissingModel: '所选模型不在当前平台列表中，请刷新后重新选择。',
    aisphereBusy: '请先停止正在运行的任务，再切换 AISphere地址。',
    aisphereRequestRejected: '该请求不属于当前 AISphere 平台。',
    chatStreamInterrupted: '回答意外中断，已保留收到的内容。请重试或要求继续。',
    chatStreamLengthLimit: '回答达到输出长度上限，内容可能不完整。可以要求继续。',
    appTitle: '晓软AI智能体',
    brandCompactName: '晓软',
    brandCompactPurpose: 'AI智能体',
    brandTheme: '政务红',
    brandPurpose: 'AI智能体',
    brandStarting: '正在准备办公工作台…',
    ...
    localInferenceRuntimeCardDescription:
      '可选组件，不影响晓软AI智能体的其他功能。选择后在应用内下载、校验和安装。',
    ...
    localInferenceImportRuntimeTooltip:
      '选择本地推理 backend 主包压缩包（zip 或 tar.gz），或选择已解压的完整目录，导入到晓软AI智能体 管理的 backend 目录。',
    ...
    codingWorkspaceDescription: '挂载一个或多个现有文件夹；晓软AI智能体不会移动或重命名磁盘文件。',
    codingWorkspaceDefaultAgent: '默认 Agent',
    codingWorkspaceName: '工作区名称',
    codingWorkspaceNamePlaceholder: '例如：晓软AI智能体',
    ...
    codingWorkspaceRemoveConfirm: '仅移除晓软AI智能体中的编程记录，不会删除磁盘文件。',
    ...
    coworkWorkingDirectoryHint: '晓软AI智能体 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为晓软AI智能体 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义晓软AI智能体 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: '晓软AI智能体 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkEngineArchInfo: '晓软AI智能体 采用双内核并行架构，两个引擎同时常驻运行，按职责固定分工：',
    coworkEnginePiRole:
    ...
    coworkConfigSaveFailed: '保存晓软AI智能体 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: '晓软AI智能体 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: '晓软AI智能体 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    agentAvatarSvgXiaoruan: '晓软AI智能体',
    ...
    mcpConnectSubtitle: '授权后，晓软AI智能体将在你允许的范围内使用此服务。',
  ...
  en: {
    ...
    aisphereAddressPlaceholder: 'https://platform-address or http://platform-address',
    aisphereDescription: 'Only models provided by the connected AISphere platform are available.',
    aisphereConnect: 'Connect and load models',
    aisphereConnecting: 'Connecting…',
    aisphereRefresh: 'Refresh models',
    aisphereConnected: 'Connected to AISphere',
    aisphereUnconfigured: 'Configure your AISphere address first.',
    aisphereDefaultModel: 'Default model',
    aisphereSelectModel: 'Select a platform model',
    aisphereNoModels: 'The platform currently has no available models.',
    aisphereInvalidAddress: 'Enter an HTTP or HTTPS platform address without an API path.',
    aisphereInvalidPlatform: 'This address did not pass AISphere verification.',
    aisphereInvalidModels: 'The platform returned an invalid model list. Contact your administrator.',
    aisphereUnavailable: 'Cannot connect to AISphere. Check the address and network, then retry.',
    aisphereMissingModel: 'This model is no longer available. Refresh and select a platform model.',
    aisphereBusy: 'Stop running tasks before switching the AISphere address.',
    aisphereRequestRejected: 'This request does not belong to the connected AISphere platform.',
    ...
    appTitle: 'Xiaoruan AI Agent',
    brandCompactName: 'Xiaoruan',
    brandCompactPurpose: 'AI Agent',
    brandTheme: 'Government Red',
    brandPurpose: 'AI Agent',
    brandStarting: 'Preparing your workspace…',
    ...
    localInferenceImportRuntimeTooltip:
      'Select a local inference backend archive (zip or tar.gz), or a fully extracted backend directory, to import into the backend directory managed by Xiaoruan AI Agent.',
    ...
    codingWorkspaceDescription:
      'Mount one or more existing folders. Xiaoruan never moves or renames files on disk.',
    codingWorkspaceDefaultAgent: 'Default agent',
    codingWorkspaceName: 'Workspace name',
    codingWorkspaceNamePlaceholder: 'For example: Xiaoruan AI Agent',
    ...
    codingWorkspaceRemoveConfirm:
      'This removes coding records from Xiaoruan only. Files on disk are never deleted.',
    ...
    // Xiaoruan AI Agent
    cowork: 'Xiaoruan AI Agent',
    coworkSettings: 'Xiaoruan AI Agent Settings',
    ...
    coworkWorkingDirectoryHint: 'Xiaoruan AI Agent will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for Xiaoruan AI Agent...',
    coworkSystemPromptHint: "Optional system prompt to customize Xiaoruan AI Agent's behavior",
    ...
    coworkModelSettingsHint:
      'Xiaoruan AI Agent uses the current model and provider configuration from Model Settings.',
    ...
    coworkEngineArchInfo:
      'Xiaoruan AI Agent runs a dual-kernel architecture with both engines running simultaneously, each with fixed responsibilities:',
    coworkEnginePiRole:
    ...
    coworkConfigSaveFailed: 'Failed to save Xiaoruan AI Agent settings. Please try again.',
    ...
    coworkPermissionDescription: 'Xiaoruan AI Agent is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'Xiaoruan AI Agent needs your input',
    ...
    mcpConnectSubtitle:
      'After authorization, Xiaoruan AI Agent will use this service within the scope you allow.',
