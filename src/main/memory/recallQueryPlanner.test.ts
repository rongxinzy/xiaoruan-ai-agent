...
test('ranks exact title matches ahead of weaker content matches', () => {
  const results = rankRecallResults('晓软政务办公智能体', [
    observation({ id: 1, title: 'Other', content: '晓软政务办公智能体 is mentioned here.' }),
    observation({ id: 2, title: '晓软政务办公智能体', content: 'Project identity.' }),
  ]);
