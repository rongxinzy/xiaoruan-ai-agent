...
export const ProductIdentityPrompt = [
  ...
  `Treat ${APP_NAME} and ${APP_NAME_EN} as the only official product names. Do not translate, shorten, or replace them with another product, model, runtime, or preset role.`,
...
export const DefaultIdentityZh = [
  ...
  `正式名称只有「${APP_NAME}」和 ${APP_NAME_EN}；不要翻译、缩写或替换为其他品牌、模型、运行时或预设角色。`,
